...
class HomeScreenBottomPart extends InheritedWidget {
	/**
	 *  获取当前实例
	 */
	static HomeScreenBottomPart of(BuildContext context) {
		return context.inheritFromWidgetOfExactType(HomeScreenBottomPart);
	}
					...
					child: StreamBuilder(
						...
						builder: (context, snapshot) {
							...
							return !snapshot.hasData
								...
								: this._buildCitiesList(context, snapshot.data.documents);
						},
					),
				)
			],
